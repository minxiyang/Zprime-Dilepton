...
for key in flavor.keys():
    ...
    for x in binCx:
        for y in binCy:
            ...
            ax.text(x, y, format(efflookup(x, y, flavor[key]), ".3f"), ha="center", va="center", color="white", fontsize=4)

    fig.savefig(f"/depot/cms/users/minxi/NanoAOD_study/Zprime-Dilepton/plots/btagging_eff_{key}.pdf")
    fig.clf()
