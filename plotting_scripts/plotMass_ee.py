...
# cfg
path_DY = (
    "/depot/cms/users/minxi/NanoAOD_study/Zprime-Dilepton/output/DY_ee/*/*.parquet"
)
other_path = (
    "/depot/cms/users/minxi/NanoAOD_study/Zprime-Dilepton/output/other/*/*.parquet"
)
path_data = (
    "/depot/cms/users/minxi/NanoAOD_study/Zprime-Dilepton/output/data/*/*.parquet"
)
