...
class frame:
        ...
        def __init__(self, xtitle, xRange, ytitle, yRange, bins, category, color, year, islogx, islogy, isMC, isFill):
                ...
                self.year = year
#cfg
path_read="/depot/cms/users/minxi/NanoAOD_study/Zprime-Dilepton/output/2018_test_march_2021_9_17_20_8_34/*/*.parquet"
path_save="/depot/cms/users/minxi/NanoAOD_study/Zprime-Dilepton/plots/"
#variables_plot = ['dimuon_mass', 'dimuon_cos_theta_cs']
variables_plot = ['jet1_pt', 'jet1_eta','jet1_btagDeepB','jet2_pt', 'jet2_eta','jet2_btagDeepB', 'dimuon_mass', 'mu1_genPartFlav', 'mu2_genPartFlav', 'mu1_ip3d', 'mu2_ip3d', 'mu1_sip3d', 'mu2_sip3d']
frames={}
...
frames['genPartFlav'] = frame('genPartFlav', [-1, 16], 'Events', [0, 30000], np.linspace(-1,16,18), "Combine", "cyan", "2018", False, False, True, True)
frames['ip3d'] = frame('ip3d', [-0.01, 0.1], 'Events', [0, 30000], np.linspace(-0.01,0.1,200), "Combine", "cyan", "2018", False, False, True, True)
frames['sip3d'] = frame('sip3d', [-1, 20], 'Events', [0, 30000], np.linspace(-1,20,200), "Combine", "cyan", "2018", False, False, True, True)
...
def plot(data,variable,path_save):
        ...
        if variable == 'dimuon_mass': var=variable
        else: var=variable.split('_')[1]
        frame = frames[var]
        ...
        #hep.cms.text()
        fig.savefig(path_save+variable+"_ttbar_noCMS.pdf")
