...
def calcMuonRecoUncert(mass, pT1, pT2, eta1, eta2,isDimuon,year):
    ...
    bb = True
    if (abs(eta1) > 1.2 or abs(eta2) > 1.2): bb = False

    if year == 2016:
        SF1 = 1.0
        SF2 = 1.0
        if (abs(eta1) <= 1.6 and p1 > 100): SF1 = (0.994 - 4.08e-6 * p1)/(0.994 - 4.08e-6 * 100)
        elif (abs(eta1) > 1.6 and p1 > 200): SF1 = ((0.9784 - 4.73e-5 * p1)/(0.9908 - 1.26e-5 * p1)) / ((0.9784 - 4.73e-5 * 200)/(0.9908 - 1.26e-5 * 200))
        if (abs(eta2) <= 1.6 and p2 > 100): SF2 = (0.994 - 4.08e-6 * p2)/(0.994 - 4.08e-6 * 100)
        elif (abs(eta2) > 1.6 and p2 > 200): SF2 = ((0.9784 - 4.73e-5 * p2)/(0.9908 - 1.26e-5 * p2)) / ((0.9784 - 4.73e-5 * 200)/(0.9908 - 1.26e-5 * 200) )
